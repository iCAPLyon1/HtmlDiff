...
class WikiDiff3 extends WfObject{
    ...
    /**
     * Inspects differences between 2 arrays
     * @param array $from
     * @param array $to
     */
    public function diff($from, $to){
        ...
        if ($this->m == 0 || $this->n == 0) {
            ...
            if ($this->m * $this->n > $this->tooLong) {
                ...
                $this->wfDebug("Limiting max number of differences to $this->maxDifferences\n");
            }
    ...
    /**
     * Calculates range difference between 2 arrays
     * @param array $from_lines
     * @param array $to_lines
     *
     * @return RangeDifference $ranges
     */
    ...
    private function find_middle_snake($bottoml1, $topl1, $bottoml2,$topl2, &$V, &$snake) {
        ...
        $snake2 = 0;
        $this->wfDebug("Computing the LCS is too expensive. Using a heuristic.\n");
